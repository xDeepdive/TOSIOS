...
export const BOTS_EASY_REACTION_TIME = 200; // ms delay before actions - much faster
export const BOTS_MEDIUM_REACTION_TIME = 100; // very fast
export const BOTS_HARD_REACTION_TIME = 50; // instant reactions
